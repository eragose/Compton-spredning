...
def get_time_counts(angle):
    data_0 = np.loadtxt("Co\Comptorn spredning "+ str(angle) + "_ch000.txt", skiprows=4)
    data_1 = np.loadtxt("Co\Comptorn spredning "+ str(angle) + "_ch001.txt", skiprows=4)
    #data fra 000
    ...
    time = (time_in_02us[-1] - time_in_02us[0])
